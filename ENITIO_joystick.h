#define SW_PIN 27  //digital output pin corresponding to joystick's built-in pushbutton switch
#define x_pin  34  //analog pin connected to X output
#define y_pin  35  //analog pin connected to Y output

#define MOVE_BOUNDARY 50  //def boundary
#define RELEASE_BOUNDARY 25  //def a range for boundary
