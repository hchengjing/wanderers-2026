...
#define FRONT_PIN 15  //GPIO pin connected to front led strip
#define TOP_PIN 2  //top
#define FRONT_NUMPIXELS 10  //num of led in front led strip
#define TOP_NUMPIXELS 5  //top
